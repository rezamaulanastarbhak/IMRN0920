                ...
                <View style={styles.kotak}>
                    <View style={styles.kotakitem}>
                        <View style={styles.labelkotak}>
                            <Text style={styles.textkotak}>Name</Text>
                        </View>
                        <View style={styles.valuekotak}>
                            <Text style={styles.valuekotaktext}>Shakibul islam</Text>
                        </View>
                    </View>
                    <View style={styles.kotakitem}>
                        <View style={styles.labelkotak}>
                    ...
                    <View style={styles.kotakitem}>
                        <View style={styles.labelkotak}>
                            <Text style={styles.textkotak}>Phone number</Text>
                        </View>
                        <View style={styles.valuekotak}>
                            <Text style={styles.valuekotaktext}>+44 213 032 578</Text>
                        </View>
                    </View>
                    <View style={styles.kotakitem}>
                        <View style={styles.labelkotak}>
                    ...
                    <View style={styles.kotakitem}>
                        <View style={styles.kotaksign}>
                            <Text style={styles.textkotaksign}>Sign Up</Text>
                        </View>
